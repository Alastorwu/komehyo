...
public class ConventPFXToJKS {
    ...
    public static final String PFX_KEYSTORE_FILE = "D:\\oneDrive\\work\\KOMEHYO\\ssl\\komehyo-china.com.pfx";// pfx文件位置
    public static final String PFX_PASSWORD = "V5YfUF07";// 导出为pfx文件的设的密码
    public static final String JKS_KEYSTORE_FILE = "D:\\oneDrive\\work\\KOMEHYO\\ssl\\komehyo.jks"; // jks文件位置
    public static final String JKS_PASSWORD = "V5YfUF07";// JKS的密码
